...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: fUKppJ6cRP5q/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: GEnUp2fCgvF9/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__uMzVl)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___5CKmc)}
              />
            </React.Fragment>
          ),
          value: args.children
